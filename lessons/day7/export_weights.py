#!/usr/bin/env python3
"""Generate the frozen 8x8 float reference and integer convolution fixtures.

Run from the repository root with:
    python -m lessons.day7.export_weights

The tensor serializer is shared with the trained model through engine/model_format.py.
This lesson defines the illustrative weights, inputs, and expected layer outputs.
"""
